...
function donation(){
    layer.tab({
        ...
        tab : [{
            title : "微信钱包",
            content : "<div style='padding:30px;overflow:hidden;background:#d2d0d0;'><img src='../static/img/wechat.jpg' width='200px' height='264px'></div>"
        },{
            title : "支付宝",
            content : "<div style='padding:30px;overflow:hidden;background:#d2d0d0;'><img src='../static/img/alipay.jpg' width='200px' height='264px'></div>"
        }]
    })
}